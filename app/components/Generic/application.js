...
angular.module('MatchCalendarApp')
    .controller('ApplicationCtrl', function ($scope, RedditPostsService, $localForage, $interval, $timeout, HtmlNotifications, $anchorScroll, $q, $stateParams, NotifcationTimeFormat) {
